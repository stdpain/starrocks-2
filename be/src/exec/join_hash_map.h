...
public:
    ...
    template <typename CppType>
    static void calc_bucket_nums(const ImmBuffer<CppType> data, uint32_t bucket_size, uint32_t num_log_buckets,
...
private:
    ...
    void _do_probe_from_ht(RuntimeState* state, const ImmBuffer<CppType> build_data,
