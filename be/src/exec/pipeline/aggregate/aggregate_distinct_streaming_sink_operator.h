...
class AggregateDistinctStreamingSinkOperatorFactory;
...
public:
    ...
    AggregateDistinctStreamingSinkOperatorFactory* factory() {
        return down_cast<AggregateDistinctStreamingSinkOperatorFactory*>(_factory);
    }
...
private:
    ...
    std::vector<RuntimeFilter*>* _build_not_in_runtime_filters(ObjectPool* pool);
...
public:
    AggregateDistinctStreamingSinkOperatorFactory(
