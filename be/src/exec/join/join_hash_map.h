...
private:
    ...
    template <bool first_probe, bool is_collision_free_and_unique>
    void _probe_from_ht(RuntimeState* state, const ImmBuffer<CppType>& build_data,
    ...
    template <bool first_probe, bool is_collision_free_and_unique>
    void _probe_from_ht_for_left_semi_join_with_other_conjunct(RuntimeState* state,
                                                               const ImmBuffer<CppType>& build_data,
                                                               const ImmBuffer<CppType>& probe_data);
