 ...
 * 
 * <p>Implementations of this interface handle scan-specific rewriting logic for different 
 * table types (e.g., Iceberg, OLAP, Hudi). Each implementation determines:
 * <ul>
 *   <li>Whether late materialization is supported for a given scan operator</li>
 *   <li>How to rewrite the scan operator with reduced columns and row IDs</li>
 * </ul>
 * 
 * <p><b>Example usage:</b>
 * <pre>{@code
