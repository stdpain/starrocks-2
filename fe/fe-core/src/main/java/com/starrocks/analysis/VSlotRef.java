...
public class VSlotRef extends Expr {
    private static final Logger LOG = LogManager.getLogger(VSlotRef.class);

    private final int slotId;
    boolean nullable;

    public VSlotRef(int slotId, boolean nullable, Type type) {
        super();
        this.slotId = slotId;
    ...
    @Override
    public Expr clone() {
        return new VSlotRef(slotId, nullable, type);
    }
}
