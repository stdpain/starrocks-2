...
public class ExchangeNode extends PlanNode {
    ...
    public boolean pushDownRuntimeFilters(DescriptorTable descTbl, RuntimeFilterDescription description, Expr probeExpr,
        ...
        // if this rf is generated by broadcast or co-location, and this rf is local.
        // it's better to put a rf at exchange node
        // because underneath scan node has to wait global rf and possibly has to wait for a long time.
    ...
    private boolean pushCrossExchange(DescriptorTable descTbl, RuntimeFilterDescription description, Expr probeExpr,
                                      List<Expr> partitionByExprs) {
